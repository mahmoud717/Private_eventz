...
RSpec.describe User, type: :model do
  before :each do
    @user = User.create!(username: 'gurbuz')
    @event1 = @user.events.create(event_date: '10.11.2021', description: 'Movie Night')
    @event2 = @user.events.create(event_date: '10.11.2020', description: 'Football Match')
